...
void efi_main(void *ImageHandle __attribute__((unused)),
    ...
    status = root->Open(root, &kernel_file, KERNEL_NAME, EFI_FILE_MODE_READ, /*Attributes=*/0);
    ...
    __asm__("	mov	%0, %%rdx\n"
            ...
            "	mov	%3, %%rsp\n"
            "	jmp	*%4\n" ::"m"(kernel_arg3),
            "m"(kernel_arg2), "m"(kernel_arg1),
            "m"(stack_base), "m"(kernel_start));
